...
// create review image
export const createReviewImage = catchAsync(async (req, res, next) => {
...
export const createReviewVideo = catchAsync(async (req, res, next) => {
  let review = await new Review({
    slug: `${nanoid(5)}`,
    ...req.body,
  }).save();
...
export const deleteReviewImage = catchAsync(async (req, res, next) => {
